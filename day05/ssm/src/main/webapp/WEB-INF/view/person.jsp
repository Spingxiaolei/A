...
<body class="gray-bg">
        ...
        <div class="row">
			  ...
			  <div class="col-lg-2">
				<div class="input-group">
					...
					<select class="form-control" name="gender" id = "txt_search_gender">
					...
					<form id="form_user" method="post" action="reservePerson.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								...
								<td>&nbsp;&nbsp;</td>
								<td>住址：</td>
								<td><input type="text" id="address" name="address" class="form-control" aria-required="true" required/></td>
							</tr>
						</table>
	...
	function initEditUser(getSelection){
		...
		$("input[value="+getSelection.gender +"]").attr('checked',true);
